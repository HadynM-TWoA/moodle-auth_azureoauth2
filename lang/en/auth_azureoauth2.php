...
$string['auth_azureclientid'] = 'Get your client ID, Secret, TenantID when you generate your Azure application. <a href="https://manage.windowsazure.com/">Windows Azure portal</a> - use the following redirect url :<br/>
...
$string['auth_domain'] = 'Domain';
$string['auth_domain_key'] = 'Set the domain name allowed to login.';

$string['communityeditionmsg'] = '';
